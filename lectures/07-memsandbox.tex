...
\linfer[composeb+composeb] {
  \linfer[assignb] {
    \linfer[assignb] {
      ...
      \lsequent{0 \le w < U, x = a, y = b}{\dbox{\pderef{w} := x}{\dbox{x := y}{x = b \land \pderef{z} = a}}}
    }
  } {
    \lsequent{0 \le w < U, x = a, y = b}{\dbox{\pderef{w} := x}{\dbox{x := y}{\dbox{y := \pderef{z}}{x = b \land y = a}}}}
  }
} {
  \lsequent{0 \le w < U, x = a, y = b}{\dbox{\pderef{w} := x; x := y; y := \pderef{z}}{x = b \land y = a}}
}
\end{sequentdeduction}
